...
export default function ScannerPage() {
  ...
  return (
    ...
    <div className="fixed inset-0 z-[200] bg-[#0a0a0a] flex flex-col overflow-hidden">
      ...
      {/* Top bar */}
      <div className="flex items-center justify-between px-4 py-3 bg-[#0a0a0a] border-b border-white/8 flex-shrink-0 z-10">
      ...
      {/* Bottom controls */}
      <div className="flex-shrink-0 bg-[#0a0a0a] border-t border-white/8 safe-area-pb">
        {cameraError && (
