        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {schedule.map((s, i) => (
                <div key={i} className="bg-[#1a1a1a] border border-[#C9A84C]/8 p-4 sm:p-5 flex gap-4">
            ...
            <div className="space-y-2">
              {categories.map(cat => (
                <details key={cat.name} className="group bg-[#1a1a1a] border border-[#C9A84C]/10">
                  <summary className="flex items-center justify-between p-4 sm:p-5 cursor-pointer select-none hover:bg-[#C8102E]/5 transition-colors list-none">
          ...
          {/* Awards */}
          <div className="bg-gradient-to-r from-[#C9A84C]/8 to-[#C8102E]/8 border border-[#C9A84C]/20 p-5 sm:p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-8">
